...
|---|---|---|
| `aut1`: лінійний шлях до `q2` | Живі: `q0,q1,q2`; мертвих немає | Поширення живості на всіх попередників фіналу |
| `aut2`: цикл `q0,q1` без шляху до `q3` | Живі: `q2,q3`; мертві: `q0,q1` | Визначення мертвої компоненти |
| `aut3`: два заключні стани | Усі стани живі | Об'єднання зворотної досяжності від кількох фіналів |
| `aut4`: цикл `a,b` і шлях `c -> d` | Живі: `c,d`; мертві: `a,b` | Цикл без шляху до фіналу не є живим |
