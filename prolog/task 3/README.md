...
1. Лінійний автомат перевіряє зворотне поширення живості через усі переходи.
2. Окремі від фіналу стани та цикл перевіряють визначення мертвих станів.
3. Два заключні стани перевіряють обхід від кількох початкових точок.
4. Цикл без шляху до фіналу перевіряє захист від нескінченного обходу.
